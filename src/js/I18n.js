  ...
  constructor()
  {
    ...
    this.translations = {
      en: {
        ...
        detailsEditHint: 'Changes affect this preview only, not the source file. Editing stops animations. Instanced meshes are edited as a whole.',
        detailsApplyOrCancel: 'Apply or cancel your edits before continuing.',
        detailsInvalidNumber: '{key}: enter a finite number for each axis.',
        detailsInvalidJson: 'User data must be a valid JSON object (not an array or null).',
      ...
      zh: {
        ...
        detailsApply: '应用',
        detailsCancel: '取消',
        detailsEditHint: '修改仅影响当前预览，不写回源文件。编辑会停止动画；实例化网格按整体编辑。',
        detailsApplyOrCancel: '请先应用或取消当前修改，再继续操作。',
        detailsInvalidNumber: '{key}：每个轴都必须填写有限数值。',
        detailsInvalidJson: '自定义数据必须是合法的 JSON 对象，不能是数组或 null。',
